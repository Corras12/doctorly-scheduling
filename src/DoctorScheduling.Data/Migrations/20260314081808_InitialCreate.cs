    ...
    public partial class InitialCreate : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[,]
                {
                    { new Guid("11111111-1111-1111-1111-111111111111"), new DateTime(2026, 3, 1, 8, 0, 0, 0, DateTimeKind.Utc), "s.mitchell@practice.nhs.uk", new Guid("a1b2c3d4-e5f6-7890-abcd-ef1234567890"), "Dr Sarah Mitchell", 1, null },
                    { new Guid("22222222-2222-2222-2222-222222222222"), new DateTime(2026, 3, 1, 8, 0, 0, 0, DateTimeKind.Utc), "j.okafor@practice.nhs.uk", new Guid("a1b2c3d4-e5f6-7890-abcd-ef1234567890"), "Nurse James Okafor", 1, null },
                    ...
                    { new Guid("44444444-4444-4444-4444-444444444444"), new DateTime(2026, 3, 1, 8, 0, 0, 0, DateTimeKind.Utc), "p.sharma@practice.nhs.uk", new Guid("b2c3d4e5-f6a7-8901-bcde-f12345678901"), "Dr Priya Sharma", 2, null },
