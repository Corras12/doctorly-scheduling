...
public static class SeedData
{
    ...
    [
        new()
        {
            ...
            EndTime = new DateTime(2026, 3, 16, 9, 30, 0, DateTimeKind.Utc),
            Location = "Staff Room",
            IsCancelled = false,
        ...
        new()
        {
            ...
            EndTime = new DateTime(2026, 3, 17, 15, 30, 0, DateTimeKind.Utc),
        ...
        new()
        {
            ...
            EndTime = new DateTime(2026, 3, 20, 11, 0, 0, DateTimeKind.Utc),
        ...
        new()
        {
            ...
            EndTime = new DateTime(2026, 3, 18, 16, 0, 0, DateTimeKind.Utc),
            Location = "IT Suite",
            IsCancelled = true,
    ...
    [
        new() { Id = Attendee1Id, EventId = Event1Id, Name = "Dr Sarah Mitchell", Email = "s.mitchell@practice.nhs.uk", Status = AttendanceStatus.Accepted, CreatedAt = new DateTime(2026, 3, 1, 8, 0, 0, DateTimeKind.Utc) },
        new() { Id = Attendee2Id, EventId = Event1Id, Name = "Nurse James Okafor", Email = "j.okafor@practice.nhs.uk", Status = AttendanceStatus.Accepted, CreatedAt = new DateTime(2026, 3, 1, 8, 0, 0, DateTimeKind.Utc) },
        ...
        new() { Id = Attendee4Id, EventId = Event2Id, Name = "Dr Priya Sharma", Email = "p.sharma@practice.nhs.uk", Status = AttendanceStatus.Declined, CreatedAt = new DateTime(2026, 3, 1, 8, 0, 0, DateTimeKind.Utc) },
